...
json_file_path = os.path.join('/home/ext_yokoga_gmail_com', 'all_data_wiki.json')
long_token_file_path = os.path.join('/home/ext_yokoga_gmail_com', 'long_token_wiki.json')
