...
json_file_path = os.path.join('/home/ext_yokoga_gmail_com', 'long_chatbot.json')
long_token_file_path = os.path.join('/home/ext_yokoga_gmail_com', 'long2_token_chatbot.json')
...
# ファイルパスを設定
file_path = '/home/ext_yokoga_gmail_com/long_token_chatbot.jsonl'

i = 0
# JSON Linesファイルを読み込み、各行のprompt項目を表示
    ...
    for line in file:
        ...
        if 'prompt' in data:
            ...
            if '</s>' not in generated_text:
                generated_text, elapsed_time = generate_response(model, tokenizer, input_ids, attention_mask, 3072)
