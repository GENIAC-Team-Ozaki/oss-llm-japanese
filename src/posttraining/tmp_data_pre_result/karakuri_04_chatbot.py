...
long_token_file_path = os.path.join('/home/ext_yokoga_gmail_com', 'long_token_chatbot.json')

# フォルダパスの指定
input_folder = '/home/ext_yokoga_gmail_com/miniconda3/work/data4'
