...
jsonl_file_path = "data/download/test_bigdata/train.jsonl"
parquet_file_path = "data/filter/test_bigdata/train_0.parquet"
deleted_jsonl_file_path = "data/deleted/test_bigdata/deleted_data.jsonl"
