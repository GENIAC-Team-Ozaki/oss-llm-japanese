...
jsonl_file_path = "../data/download/wiktionary/train.jsonl"
parquet_file_path = "../data/filter/wiktionary/train_0.parquet"
deleted_jsonl_file_path = "../data/deleted/wiktionary/deleted_data.jsonl"
